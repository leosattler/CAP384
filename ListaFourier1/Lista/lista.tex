...
\include{./docs/prefacio} %% 1o capítulo, começo do texto
...
\newpage
\include{./docs/exe1} %% 1o capítulo, começo do texto

\clearpage
\include{./docs/exe2} %% 2o capítulo

\clearpage
\include{./docs/exe3} %% 3o capítulo

\clearpage
\include{./docs/exe4} %% 4o capítulo

\clearpage
\include{./docs/exe5} %% 1o capítulo, começo do texto

\clearpage
\include{./docs/exe6} %% 2o capítulo

\clearpage
\include{./docs/exe7} %% 3o capítulo

\clearpage
\include{./docs/exe8} %% 4o capítulo

\clearpage
\include{./docs/exe9} %% 3o capítulo
