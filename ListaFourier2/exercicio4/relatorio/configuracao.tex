...
\titulo{Espectrogramas dos dados do Fluxo Solar F10.7}
\title{Espectrogramas dos dados do Fluxo Solar F10.7} %% 
\author{Leonardo Sattler Cassará} %% coloque o nome do(s) autor(es)
\descriccao{Relatório apresentado aos professores Margarete Domingues e Luciano Magrini como parte da avaliação do curso CAP-384.}
...
\date{16 de outubro de 2020}%ano da publicação
