...
\include{./docs/introducao} %% 1o capítulo, começo do texto

\include{./docs/metodologia} %% 2o capítulo
%\clearpage
\include{./docs/resultados} %% 3o capítulo

%\clearpage{}
\include{./docs/consideracoes_finais} %% 5o capítulo
