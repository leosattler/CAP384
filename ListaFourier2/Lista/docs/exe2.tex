...
\lstinputlisting[language=python, style=mystyle, firstline=75, lastline=78]{../scripts/exercicio2/janelas/window_plots.py}


Janela de \textbf{Hanning}:
\lstinputlisting[language=python, style=mystyle, firstline=80, lastline=83]{../scripts/exercicio2/janelas/window_plots.py}


Janela de \textbf{Hamming}:
\lstinputlisting[language=python, style=mystyle, firstline=85, lastline=88]{../scripts/exercicio2/janelas/window_plots.py}


Janela de \textbf{Barllet}:
\lstinputlisting[language=python, style=mystyle, firstline=90, lastline=93]{../scripts/exercicio2/janelas/window_plots.py}


Janela de \textbf{Papoulis}:
\lstinputlisting[language=python, style=mystyle, firstline=95, lastline=100]{../scripts/exercicio2/janelas/window_plots.py}


Janela de \textbf{Tukey}:
\lstinputlisting[language=python, style=mystyle, firstline=102, lastline=129]{../scripts/exercicio2/janelas/window_plots.py}
...
% FIGURA
\begin{figure}[ht!]
	\legenda{Figura 2.1: Transformadas de Fourier das funções janela utilizadas neste exercício com largura igual a 0.5.}
	\vspace{2mm}	% acrescentar o espaçamento vertical apropriado entre o título e a borda superior da figura
	\begin{center}
...
\lstinputlisting[language=python, style=mystyle, firstline=178, lastline=228]{../scripts/exercicio2/espectros/window_spectra.py}
...
\lstinputlisting[language=python, style=mystyle, firstline=232, lastline=283]{../scripts/exercicio2/espectros/window_spectra.py}
...
Espectrogramas do \textbf{chirp gaussiano}, $-02 \leq t \leq 2$ e tamanho das janelas = 0.5: Figura 2.5.
...
As Figuras 2.10 e 2.11 (chirp quadrático), quando contrastadas, também ilustram a incapacidade das janelas de tamanho igual a 0.1 de contribuir para a análise deste chirp. As Figuras 2.11 e 2.12 atestam a variação quadrática da frequência do chirp analisado com o tempo.
